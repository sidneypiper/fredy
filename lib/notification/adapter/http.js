...
const mapListing = (listing, baseUrl) => ({
  ...
  // Absent rather than null when no message was generated, so a consumer cannot mistake "not
  // generated" for an empty message.
  ...(listing.personalizedMessage ? { personalizedMessage: listing.personalizedMessage } : {}),
  url: listing.link,
