...
import { PERSONALIZED_MESSAGE_LABEL } from '../personalizedMessage.js';
...
const buildEmbed = (jobKey, listing, baseUrl) => {
  ...
  if (listing.personalizedMessage) {
    fields.push({
      name: PERSONALIZED_MESSAGE_LABEL,
      value: listing.personalizedMessage.slice(0, 1024),
      inline: false,
    });
  }
