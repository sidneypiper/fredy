 ...
 * 14) Calculate travel times to the user's addresses
 * 15) Filter out entries that do not match the job's travelTimeCondition
...
class FredyPipelineExecutioner {
   ...
   * commute of any selected place is soft-deleted here and never reaches a notification. It runs
   * after the travel times were computed by {@link _calculateTravelTimes}, so it costs no requests
   * of its own.
   *
