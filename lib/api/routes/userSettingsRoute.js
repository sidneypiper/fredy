...
export default async function userSettingsPlugin(fastify) {
  ...
  // The AI provider is a global configuration: every job's personalized messages use the same
  // model and key. The key is stored in the settings table like every other secret and filtered
  // from every HTTP response by NON_SERIALIZABLE_SETTINGS.
