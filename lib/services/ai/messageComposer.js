 ...
 *
 * The ad sentence is a reflection exercise, not a sales pitch: it echoes the points the listing
 * itself emphasizes - the same words are fine, but never as a verbatim copy of a listing
 * sentence - and may add a light, realistic reaction. {{AGREEMENTS}} is where the user wants the
 * practical details (furniture take-over, kitchen purchase) acknowledged, with the price the
 * listing states.
 */
...
4. {{AD_SENTENCE}}: Replace with exactly ONE sentence that shows the applicant read the listing carefully and is specifically interested in THIS apartment - what sets it apart from others. The psychological goal is to MIRROR the landlord's own style and reasoning: pick up the points the listing itself emphasizes and echo them back, as a reflection. You may add a light interpretation or reaction to what the listing highlights (e.g. that the balcony would be a lovely place to start the day), but keep it realistic and grounded in the listing - no invented facts, no artificial causal reasoning ("the living is very efficient because of the kitchen"). You MAY use the same words the listing uses, but the sentence must not be a verbatim copy of any listing sentence. When unsure, phrase cautiously ("as far as I can see from the listing"). NEVER output the placeholder itself.
