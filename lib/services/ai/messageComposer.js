 ...
 * to forget a constraint buried after ten content rules. Four worked examples follow in the
...
{{AD_SENTENCE}} - At most ONE sentence about what makes THIS apartment genuinely distinctive, grounded only in the listing's description, title and address - a concrete feature, an unusual characteristic, or a specific location detail that sets it apart. Show the applicant read the listing. You may reuse the listing's words, but never copy a whole sentence verbatim. Do not invent details. Do NOT state generic things that apply to most apartments ('ruhige Lage', 'helle Räume', 'durchdachte Aufteilung', 'zentral gelegen' on their own). If nothing in the listing is genuinely noteworthy, replace the placeholder with an empty string and drop the blank line it leaves. Never output the placeholder itself.
...
Four worked examples follow in the conversation below. Match their style exactly.`;
...
Ich kann ab dem {{MOVE_IN_DATE}} einziehen und stehe für Besichtigungen kurzfristig zur Verfügung. Sie erreichen mich telefonisch am besten unter +4915112345678.
...
/**
 * Four worked input/output pairs for the few-shot prefix. Each input is the real base text plus
 * a real listing; each output is the finished message the user approved. They cover the variations
 * a small model needs to see:
 *  - unknown vs. named agent (examples 1 and 4 vs. 2 and 3),
 *  - an ad sentence when the listing has a distinctive detail vs. NO ad sentence when it is
 *    generic (examples 2-4 vs. 1) - the model must leave {{AD_SENTENCE}} empty rather than invent
 *    generic praise,
 *  - no agreements vs. a kitchen/furniture take-over (examples 1, 2 and 4 vs. 3) - and, crucially,
 ...
 *  - a fixed date vs. a flexible move-in (examples 1, 3, 4 vs. 2).
 */
...
Ich kann ab dem 13.11.2026 einziehen und stehe für Besichtigungen kurzfristig zur Verfügung. Sie erreichen mich telefonisch am besten unter +4915112345678.
...
Besonders begeistert mich der nach Süden ausgerichtete Balkon mit Ausblick auf den ruhigen Innenhof dieser Wohnung.
...
Ich kann flexibel einziehen und stehe für Besichtigungen kurzfristig zur Verfügung. Sie erreichen mich telefonisch am besten unter +4915112345678.
...
Ich kann ab dem 10.10.2026 einziehen und stehe für Besichtigungen kurzfristig zur Verfügung. Sie erreichen mich telefonisch am besten unter +4915112345678.
...
Besonders begeistert mich die außergewöhnliche, moderne Struktur dieser Galeriewohnung mit ihren extrem hohen Decken, der separaten Galerie und der zentralen Lage direkt am Rathenauplatz.

Um Ihnen als Vermieterin absolute finanzielle Sicherheit und Planbarkeit zu garantieren, habe ich zudem eine vollumfängliche, unterschriebene Elternbürgschaft vorbereitet. Diese bringe ich gerne zur Besichtigung mit oder schicke sie Ihnen vorab als PDF.

Meine Bonität und Einkommenssituation können Sie sofort einsehen: Meine geprüfte Bewerbermappe (inkl. aktueller Schufa, Gehaltsnachweisen und verifizierten Mietzahlungen) habe ich in dieser Anfrage bereits vollständig für Sie freigeschaltet.

Ich kann ab dem 01.10.2026 einziehen und stehe für Besichtigungen kurzfristig zur Verfügung. Sie erreichen mich telefonisch am besten unter +4915112345678.
