...
import { IconHome, IconMapPin, IconListView, IconBell, IconComment } from '@douyinfe/semi-icons';
...
export default function SettingsLayout() {
  ...
  const tabs = [
    ...
    { path: '/settings/ai', label: t('settings.tabAI'), icon: <IconComment size="small" /> },
  ];
